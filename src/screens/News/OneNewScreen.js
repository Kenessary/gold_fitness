...
const OneNewScreen = ({ route }) => {
  return (
    ...
    >
      <Image
        source={{ uri: `data:image/png;base64,${route.params.oneNew.photo}` }}
        style={{
          height: 200,
          width: "100%",
